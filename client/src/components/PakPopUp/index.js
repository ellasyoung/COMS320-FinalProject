...
import { Dim, Modal, CloseButton, NextButton, Title, Blurb, Img, Row, Minerals, Section, DropdownTitle, DropdownContent, ExpandButton, ScrollCont, PhoneImage } from "../GhanaPopUp/WasteElements";
import ThisImage from "../../assets/pak-img.jpg";
import Phone from "../../assets/phonecases/pakistan-phonecase.png";
