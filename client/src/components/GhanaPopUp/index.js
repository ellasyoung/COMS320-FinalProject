...
import { Dim, Modal, CloseButton, NextButton, Title, Blurb, Img, Row, Minerals, Section, DropdownTitle, DropdownContent, ExpandButton, ScrollCont, PhoneImage } from "./WasteElements";
import ThisImage from "../../assets/ghana-img.jpg";
import Phone from "../../assets/phonecases/ghana-phonecase.png";
